  ...
  return (
    <section id="projects" className="w-full">
      ...
      <div
        ...
        className="sm:grid md:grid-cols-[repeat(3, 33%)] sm:grid-cols-[repeat(2,50%)] flex flex-col md:justify-center gap-3 sm:items-start items-center rounded-none md:mx-[12.5%] mx-[5%]"
      >
        <ProjectCard
          url=""
