  ...
  const contactSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const res = await fetch(
        `${process.env.REACT_APP_SERVER_URL}/router/contactEmail`,
        {
          method: "POST",
          headers: {
        ...
        <section className="connect-section">
          <ul className="connect-ul">
            <li className="connect-li">
              <Socials github={true} vertAlign="top" />
            </li>
            <li className="connect-li">
              <Socials linkedin={true} vertAlign="top" />
            </li>
            <li className="connect-li">
              <Socials gmail={true} vertAlign="top" />
            </li>
          </ul>
        </section>
      </div>
